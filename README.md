...
* The blue histogram represents the posterior distribution of possible ```BFire``` values across the entire community, i.e. the distribution yielded by ```dnorm(BFire_sp_mean, BFire_sp_sd)```
