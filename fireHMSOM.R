...
#NIMBLE uses the same syntax as BUGS and JAGS, which are just other MCMC samplers, but it is much faster (for these models at least)
#and it has a nice community page where you can ask questions https://groups.google.com/g/nimble-users
